...
def main():
    ...
    parser.add_argument("-b", "--max-batch-size", default=1, type=int, help="The max batch size for the TensorRT engine input")
    ...
    parser.add_argument("--max-calibration-size", help="(INT8 ONLY) The max number of data to calibrate on from --calibration-data.", type=int, default=1)
