...
# https://github.com/kocurvik/retinanet_traffic_3D
sys.path.append("/home/g/gajdosech2/retinanet_traffic_3D/")
...
if __name__ == "__main__":
    ...
    name = 'system_yolov6_small_b32_640_352_fp32_luvizon_retrained.json'
    ...
    for pred, gt in zip(pred_list, gt_list):
        results.extend(test_video(pred, gt, scales))
