...
#python speed_estimation.py --conf-thres 0.5 --luvizon --yolo-img-size 544 960 --test-name=yolov6_nano_b32_960_544_fp32_luvizon --model_path=/home/g/gajdosech2/YOLOv6_transform_3d/runs/train/exp2/weights/best_ckpt.pt --root_dir_video_path /home/k/kocur15/data/luvizon/dataset --root_dir_results_path /home/g/gajdosech2/data/luvizon-iou0_5-conf0_5/results --processing-batch=32
echo "Nano FP32 960x544 finished..."

echo "Running nano model FP32 640x352..."
#python speed_estimation.py --conf-thres 0.5 --luvizon --yolo-img-size 352 640 --test-name=yolov6_nano_b32_640_352_fp32_luvizon --model_path=/home/g/gajdosech2/YOLOv6_transform_3d/runs/train/exp2/weights/best_ckpt.pt --root_dir_video_path /home/k/kocur15/data/luvizon/dataset --root_dir_results_path /home/g/gajdosech2/data/luvizon-iou0_5-conf0_5/results --processing-batch=32
echo "Nano FP32 640x352 finished..."

echo "Running nano model FP32 480x256..."
#python speed_estimation.py --conf-thres 0.5 --luvizon --yolo-img-size 256 480 --test-name=yolov6_nano_b32_480_256_fp32_luvizon --model_path=/home/g/gajdosech2/YOLOv6_transform_3d/runs/train/exp2/weights/best_ckpt.pt --root_dir_video_path /home/k/kocur15/data/luvizon/dataset --root_dir_results_path /home/g/gajdosech2/data/luvizon-iou0_5-conf0_5/results --processing-batch=32
...
python speed_estimation.py --luvizon --yolo-img-size 352 640 --test-name=yolov6_small_b32_640_352_fp32_luvizon --model_path=/home/g/gajdosech2/YOLOv6_transform_3d/runs/train/exp1/weights/best_ckpt.pt --root_dir_video_path /home/k/kocur15/data/luvizon/dataset --root_dir_results_path /home/g/gajdosech2/data/luvizon/results --processing-batch=32
